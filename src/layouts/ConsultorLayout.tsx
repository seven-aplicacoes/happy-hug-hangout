...
const consultorCoreLinks = [
  { title: 'Meus Clientes', url: '/consultor/clientes', icon: Users, module: 'clientes' },
  { title: 'Meu Perfil', url: '/consultor/meu-perfil', icon: UserCircle, module: 'perfil' },
];

const consultorOperationalLinks = [
  { title: 'Minhas Reuniões', url: '/consultor/reunioes', icon: CalendarDays, module: 'reunioes' },
  { title: 'Minhas Tarefas', url: '/consultor/tarefas', icon: CheckSquare, module: 'tarefas' },
  { title: 'Documentos', url: '/consultor/documentos', icon: FileText, module: 'documentos' },
];
              ...
              {can('dashboard') && (
                <SidebarMenuItem>
                  <SidebarMenuButton asChild className="h-10">
                    ...
                    >
                      <LayoutDashboard className="mr-3 h-[18px] w-[18px]" strokeWidth={1.5} />
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <header className="h-14 border-b border-border/60 bg-card/80 backdrop-blur-sm flex items-center justify-between px-5 shrink-0">
            <div className="flex items-center gap-3">
              ...
              <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-muted-foreground">Consultor</span>
            </div>
