  ...
  public: {
    Tables: {
      ...
      client_onedrive_links: {
        ...
        Relationships: [
          {
            foreignKeyName: "client_onedrive_links_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
            referencedRelation: "clients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "client_onedrive_links_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
